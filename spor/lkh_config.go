...
const (
	...
	InvalidDistanceMatrix RetCode = -100
	InvalidFixedEdges     RetCode = -101
	NoLowerBound          RetCode = -401
	NoCandidates          RetCode = -402
	InvalidTour           RetCode = -301
	LossPoint             RetCode = -302
	MaxFl                         = 100000000000
	MinFl                         = -1000000000
	DeepCoefficient               = 0.3
	SolCoefficient                = 0.3
