...
func makeEdge(n1 *TSPNode, n2 *TSPNode, tour *Tour) Edge {
...
func (t *Tour) closest(ni *TSPNode, destroyed map[Edge]bool, repaired map[Edge]bool, gain int) closestList {
...
func chooseX(tour *Tour, n1 *TSPNode, last *TSPNode, destroyed map[Edge]bool, repaired map[Edge]bool, gain, k int, endTime time.Time) bool {
...
func chooseY(tour *Tour, n1 *TSPNode, n2i *TSPNode, destroyed map[Edge]bool, repaired map[Edge]bool, gain, k int, endTime time.Time) bool {
